...
func (m *Metrics) Handler() http.HandlerFunc {
	return func(w http.ResponseWriter, _ *http.Request) {
		...
		fmt.Fprintf(w, "# HELP energy_watchdog_surplus_watts Averaged grid export; negative means the house is importing.\n")
		fmt.Fprintf(w, "# TYPE energy_watchdog_surplus_watts gauge\n")
		fmt.Fprintf(w, "energy_watchdog_surplus_watts %g\n", m.surplus)
		fmt.Fprintf(w, "# HELP energy_watchdog_surplus_raw_watts Instantaneous grid export (not used for decisions).\n")
